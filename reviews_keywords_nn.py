...
read = json.load(open('datasets/Subway Surfers/Reviews_Subway Surfers_all.json', 'r', encoding="utf-8"))
...
def write_reviews_keywords():
    filename = "datasets/Subway Surfers/Reviews_Subway Surfers_all_keywords_nn.json"
...
def write_reviews_keywords_jj_distinct():
    filename = "datasets/Subway Surfers/Reviews_Subway Surfers_distinct_keywords_nn.json"
